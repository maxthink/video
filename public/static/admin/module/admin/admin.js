layui.define(["layer"], function (f) {
    ...
    m.events = {
        ...
        theme: function () {
            ...
            m.popupRight({
                id: "layer-theme",
                type: 2,
                content: n ? n : "/static/admin/tpl/theme.html"
            });
        },
        note: function () {
            var n = h(this).attr("data-url");
            m.popupRight({
                ...
                type: 2,
                closeBtn: false,
                content: n ? n : "/static/admin/tpl/note.html"
            });
        },
        message: function () {
            var n = h(this).attr("data-url");
        ...
        psw: function () {
            ...
            m.open({
                ...
                title: "修改密码",
                shade: 0,
                content: n ? n : "/static/admin/tpl/password.html"
            });
        },
        logout: function () {
            var n = h(this).attr("data-url");
    ...
    h("body").on("click", "*[tw-event]",
            function () {
                var n = h(this).attr("tw-event");
                var o = m.events[n];
                o && o.call(this, h(this));
            });
    h("body").on("click", "*[tw-href]",
            function () {
                var n = h(this).attr("tw-href");
                var o = h(this).text();
    ...
    var i = false;
    h("body").on("mouseenter", ".layui-layout-admin.admin-nav-mini .layui-side .layui-nav .layui-nav-item>a",
            function () {
            ...
            }).on("mouseleave", ".layui-layout-admin.admin-nav-mini .layui-side .layui-nav .layui-nav-item>a",
            function () {
                k.closeAll("tips");
            });
    h("body").on("mouseleave", ".layui-layout-admin.admin-nav-mini .layui-side",
            function () {
                i = false;
                setTimeout(function () {
                    if (!i) {
    ...
    h("body").on("mouseenter", ".layui-layout-admin.admin-nav-mini .layui-side .layui-nav .layui-nav-item.admin-nav-hover .layui-nav-child",
            function () {
                i = true;
            });
