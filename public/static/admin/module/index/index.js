;layui.define(["layer", "element", "admin", "contextMenu"], function(s) {
    ...
    if (h.pageTabs && d(n).length <= 0) {
        ...
        e += "   </div>";
        e += '   <div class="layui-icon admin-tabs-control layui-icon-prev" tw-event="leftPage"></div>';
        e += '   <div class="layui-icon admin-tabs-control layui-icon-next" tw-event="rightPage"></div>';
        ...
        e += '               <dd tw-event="closeThisTabs" lay-unselect><a>关闭当前标签页</a></dd>';
        e += '               <dd tw-event="closeOtherTabs" lay-unselect><a>关闭其它标签页</a></dd>';
        e += '               <dd tw-event="closeAllTabs" lay-unselect><a>关闭全部标签页</a></dd>';
        e += "            </dl>";
        e += "         </li>";
        e += "      </ul>";
        e += "   </div>";
